...
export class ShieldWalletAdapter extends BaseMessageSignerWalletAdapter {
    ...
    url = 'https://shield.xyz';
    icon = 'data:image/svg+xml;base64,';
    ...
    constructor(config: ShieldWalletAdapterConfig = {}) {
        ...
        if (this._readyState !== WalletReadyState.Unsupported) {
            scopePollingDetectionStrategy(() => {
                const shieldWallet = (window as any)?.shieldWallet || (window as any)?.shield;
                if (shieldWallet) {
    ...
    async connect(decryptPermission: DecryptPermission, network: WalletAdapterNetwork, programs?: string[]): Promise<void> {
        try {
            ...
            const wallet = (window as any)?.shieldWallet || (window as any)?.shield;
